...
import (
	...
	"github.com/FusionFoundation/efsn/contracts/chequebook"
	...
	"github.com/FusionFoundation/efsn/p2p/protocols"
	"github.com/FusionFoundation/efsn/params"
	"github.com/FusionFoundation/efsn/rpc"
	"github.com/FusionFoundation/efsn/swarm/api"
	httpapi "github.com/FusionFoundation/efsn/swarm/api/http"
	"github.com/FusionFoundation/efsn/swarm/fuse"
	"github.com/FusionFoundation/efsn/swarm/log"
	"github.com/FusionFoundation/efsn/swarm/network"
	"github.com/FusionFoundation/efsn/swarm/network/stream"
	"github.com/FusionFoundation/efsn/swarm/pss"
	"github.com/FusionFoundation/efsn/swarm/state"
	"github.com/FusionFoundation/efsn/swarm/storage"
	"github.com/FusionFoundation/efsn/swarm/storage/mock"
	"github.com/FusionFoundation/efsn/swarm/storage/mru"
	"github.com/FusionFoundation/efsn/swarm/tracing"
)
...
func NewSwarm(config *api.Config, mockStore *mock.NodeStore) (self *Swarm, err error) {
	...
	addr := &network.BzzAddr{
		...
		UAddr: []byte(discover.NewNode(nodeID, net.IP{127, 0, 0, 1}, 40404, 40404).String()),
	}
